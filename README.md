...
### 3.2. Canva AI / DALL·E
Mục đích sử dụng:
- Tạo ý tưởng hình ảnh minh họa cho Hero và Project.
- Gợi ý phong cách màu sắc, bố cục hình ảnh và concept trực quan.

Ví dụ prompt:
```text
Create a modern flat illustration for a personal portfolio website about AI-assisted web design,
using teal, navy and warm yellow colors, clean background, professional and friendly style.
```

```text
Design a simple illustration of a student building a portfolio website with AI tools,
modern flat vector style, clean layout, suitable for a recruiter-friendly portfolio.
```
...
## 8. Hướng dẫn triển khai GitHub Pages
...
## 9. Thông tin cần thay trước khi nộp
